...
Class Registered {
    ...
    public function CountAllNewMember() {
        ...
        return ModelRegistration::where(function ($query) {
                ...
                //$query->from('registration')->whereDate('created_at', now()->subDays(2));
    ...
    public function CountDays() {
        ...
        return ModelRegistration::where(function ($query) {
                ...
                //$query->from('registration')->whereDate('created_at', now()->subDays(7));
    ...
    public function CountNewEncoded() {
		...
		$query->from('registration')->where('manual',1)->whereRaw("DATE(created_at) = '" .date('Y-m-d'). "'");
    ...
    public function CountNewOnline() {
        ...
        return ModelRegistration::where(function ($query) {
                ...
                // $query->from('registration')->whereDate('created_at', now()->subDays(5));
                $query->from('registration')->where('manual',0)->whereRaw("DATE(created_at) = '" .date('Y-m-d'). "'");
