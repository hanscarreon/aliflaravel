...
Route::group(['middleware' => ['role:admin'], 'prefix' => 'pcvl'], function (){
    Route::get('/get', 'pcvl\PcvlController@pcvlViewAll')->name('pcvlViewAll');
    Route::post('/filter/alif', 'pcvl\PcvlController@submitFilterPcvl')->name('submitFilterPcvl');
});

// Route::get('pcvl/get', 'pcvl\PcvlController@pcvlViewAll')->name('pcvlViewAll');
