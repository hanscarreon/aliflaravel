            ...
            $('#provinceid').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#cityid').append(
                            `<option value="" disabled selected>-Select City/Munisipalidad-</option>`
                        );
                        response.forEach(element => {
                            $('#cityid').append(
                                `<option value="${element['city_municipality_code']}">${element['city_municipality_description']}</option>`
                            );
                        });
            ...
            $('#cityid').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.forEach(element => {
                            $('#brgyid').append(
                                `<option value="${element['barangay_code']}">${element['barangay_description']}</option>`
                            );
                        });
