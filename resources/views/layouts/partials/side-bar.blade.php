    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            @role('admin')
                ...
                <li {{ Route::is('pcvlViewAll')  ? 'class=active' : '' }}>
                    <a href="{{ route('pcvlViewAll') }}">
                        <i class="nc-icon nc-money-coins"></i>
                        <p>PCVL Data</p>
                    </a>
                </li>
                ...
                <li
                    {{ Route::is('permissions.index') ||Route::is('permissions.create') ||Route::is('permissions.edit') ||Route::is('roles.index') ||Route::is('roles.create') ||Route::is('roles.edit') ||Route::is('users.index') ||Route::is('users.create') ||Route::is('users.edit')? 'class=active': '' }}>
